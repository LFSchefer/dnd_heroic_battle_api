        ...
        for (String monsterUrl : monsterUrls) {
            ...
            actionsApi.forEach(action -> {
                ...
                if (usage != null) {
                    ...
                    Integer usageTime = usage.get("times") == null ? 0 : (Integer) usage.get("times");
            ...
            actionsApi.forEach(action -> {
                ...
                if (damageApi != null) {
                    damageApi.forEach(damage -> {
                        String damageDice = damage.get("damage_dice") == null ? "0" : (String) damage.get("damage_dice");
